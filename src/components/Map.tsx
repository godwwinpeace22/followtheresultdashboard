...
type data = {
  ...
  lon: number;
  popupText: string;
  icon: "RedIcon" | "BlackIcon" | "GreenIcon";
}[];
...
export default function Map({ data }: { data: data }) {
  ...
  <g>
      ...
      <circle style="fill:#e71111;" cx="15.979" cy="15.977" r="15.117"/>
  </g>
  </svg>`)}`;
  ...
  const GREEN_MARKER = `data:image/svg+xml;utf8,${encodeURIComponent(`<?xml version="1.0" encoding="iso-8859-1"?>
  <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
  <svg height="80px" width="80px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
       viewBox="0 0 31.955 31.955" xml:space="preserve">
  <g>
      
      <circle style="fill:#0a7a55;" cx="15.979" cy="15.977" r="15.117"/>
  </g>
  </svg>`)}`;
