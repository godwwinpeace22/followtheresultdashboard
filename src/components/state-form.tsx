          ...
          >
            ...
            <div className="mb-5">
              ...
              >
                ...
                election by entering the votes scored by each Political Party in
                the original copy of Forms EC60H in figures and words?
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the inec staff paste the results in an open place for public
                review at collation center? Choose: Yes or No
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
