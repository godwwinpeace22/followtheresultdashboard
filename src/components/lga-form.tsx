          ...
          >
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Was the result transmitted electronically to INEC server in your
                presence?
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
                    ...
                    id="hs-radio-group-1"
                    defaultChecked
                    {...register("electronic_transmission", { required: true })}
                  />
                  {errors.electronic_transmission && (
          ...
          >
            <div className="mb-5">
              ...
              >
                ...
                original copies of Forms EC8B from the Registration Area/Ward
                Collation officers together with other materials and reports
                relating to the election, including Form EC40(G)
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the LGA/AC Collation Officer cross-check the totals and
                entries in the EC8C with the Collation Support and Result
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the LGA/AC Collation Officer sign, date and stamp the forms
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the LGA/AC Collation Officer distribute copies of the forms
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the LGA/AC Collation Officer electronically transmit or
                transfer the result directly to the next level of collation, as
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the LGA/AC Collation Officer paste the results in an open
              ...
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
                    ...
                    id="hs-radio-group-1"
                    defaultChecked
                    {...register("process_9", { required: true })}
                  />
                  {errors.process_9 && (
                    <small className="text-red-500">
                      This field is required
          ...
          >
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Was there any incident of election-related violence upon your
                arrival at your LGA Collation Center?
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Was there any incident of election-related violence during the
                process of collation of results at your LGA Collation Center?
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Was there any incident of election-related violence following
                the announcement of the results at your LGA Collation Center?
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the violence result in the interruption of the collation or
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                What was the response of security officials at the LGA Collation
                Center to the violence?
              </label>
              <input
                type="text"
                min={0}
