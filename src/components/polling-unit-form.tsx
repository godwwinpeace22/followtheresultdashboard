          ...
          >
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                What time did the INEC ad-hoc staff arrive at the polling unit?
              </label>
              <input
                type="time"
                id="input-label"
          ...
          >
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the Presiding Officer (PO) announce loudly the votes scored
            ...
            <div className="mb-5">
              <label
                ...
                className="block text-sm font-medium mb-2 dark:text-white"
              >
                Did the Presiding Officer (PO) distribute copies of the forms to
                the polling agents and the Police?
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
                  <input
            ...
            <div className="mb-5">
              ...
              >
                ...
                transfer the result directly to the IREV Portal as prescribed by
                the Commission?
              </label>
              <div className="flex gap-x-6">
                <div className="flex">
