...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between lg:p-24">
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 grid-cols-2 lg:grid-cols-4 lg:text-left">
        <Link
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>LGA Collation</p>
        </Link>
